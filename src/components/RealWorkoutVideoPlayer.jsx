...
export const EXERCISE_VIDEO_MAP = {
  // CHEST EXERCISES
  'Incline Dumbbell Press (30°)': { youtubeId: '0G2_kW746co', title: 'Incline Dumbbell Bench Press (30°)', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-exercising-incline-bench-press-40919-large.mp4' },
  ...
  'Incline Machine Chest Press': { youtubeId: 'xUm0BiKGb10', title: 'Incline Machine Chest Press', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-exercising-incline-bench-press-40919-large.mp4' },
  'Incline Push-Ups (Hands on Bench)': { youtubeId: 'Z0bRiVnH48I', title: 'Incline Push-Ups', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-exercising-incline-bench-press-40919-large.mp4' },
  'Incline Push-Up (Hands Elevated)': { youtubeId: 'Z0bRiVnH48I', title: 'Incline Push-Up (Hands Elevated)', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-exercising-incline-bench-press-40919-large.mp4' },
  ...
  'Reverse-Grip Barbell Bench Press': { youtubeId: 'F2o_k_o25nU', title: 'Reverse-Grip Barbell Bench Press', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-training-with-a-barbell-on-a-bench-40920-large.mp4' },
  'Landmine Incline Chest Press': { youtubeId: '2b4M4qA1W2s', title: 'Landmine Incline Chest Press', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-exercising-incline-bench-press-40919-large.mp4' },
  ...
  'Seated Machine Chest Press': { youtubeId: 'xUm0BiKGb10', title: 'Seated Machine Chest Press', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-training-with-a-barbell-on-a-bench-40920-large.mp4' },
  ...
  'Standing Cable Crossover (Mid-Chest)': { youtubeId: 'taI4XduLp4M', title: 'Standing Cable Crossover (Mid-Chest)', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-athlete-working-out-with-cable-machine-42861-large.mp4' },
  'Standing Cable Crossover (Mid-Chest Flye)': { youtubeId: 'taI4XduLp4M', title: 'Standing Cable Crossover (Mid-Chest Flye)', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-athlete-working-out-with-cable-machine-42861-large.mp4' },
  'Pec Deck Flye Machine': { youtubeId: 'eGjt4lkGeZ4', title: 'Pec Deck Flye Machine', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-athlete-working-out-with-cable-machine-42861-large.mp4' },
  ...
  'Dumbbell Squeeze Press (Hex Press)': { youtubeId: 'yG2k0sR3dYw', title: 'Dumbbell Squeeze Press (Hex Press)', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-training-with-a-barbell-on-a-bench-40920-large.mp4' },
  'Decline Dumbbell Press (Light)': { youtubeId: '0xNwTshH_ag', title: 'Decline Dumbbell Press', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-training-with-a-barbell-on-a-bench-40920-large.mp4' },
  'Decline Dumbbell Press': { youtubeId: '0xNwTshH_ag', title: 'Decline Dumbbell Press', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-training-with-a-barbell-on-a-bench-40920-large.mp4' },
  ...
  'Low-to-High Cable Flye': { youtubeId: 'taI4XduLp4M', title: 'Low-to-High Cable Flye', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-athlete-working-out-with-cable-machine-42861-large.mp4' },
  ...
  'Dumbbell Pullover (Decline Bench)': { youtubeId: 'FK4rkP1Z7l0', title: 'Dumbbell Pullover', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-training-with-a-barbell-on-a-bench-40920-large.mp4' },
  ...
  'Machine Lateral Raise': { youtubeId: 'f_p1z2b0V5k', title: 'Machine Lateral Raise', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-exercising-lateral-raises-with-dumbbells-40924-large.mp4' },
  ...
  'Drag Curl (Barbell / Smith)': { youtubeId: 'Kz7vF4lGf2Q', title: 'Drag Curl (Barbell / Smith)', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-young-man-exercising-his-biceps-with-dumbbells-40927-large.mp4' },
  'High Cable Bicep Curl (Hercules Curl)': { youtubeId: 'e22Xg672t8w', title: 'High Cable Bicep Curl', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-young-man-exercising-his-biceps-with-dumbbells-40927-large.mp4' },

  // TRICEPS
  'Overhead Cable Tricep Extension': { youtubeId: '_gsU1369vJw', title: 'Overhead Cable Tricep Extension', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-doing-triceps-exercises-with-cable-machine-42862-large.mp4' },
  'Cable Overhead Tricep Extension (Low Pulley)': { youtubeId: '_gsU1369vJw', title: 'Cable Overhead Tricep Extension', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-doing-triceps-exercises-with-cable-machine-42862-large.mp4' },
  ...
  'Skull Crushers (Lying EZ Bar Extension)': { youtubeId: 'd_KZxkY_0aw', title: 'Skull Crushers', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-doing-triceps-exercises-with-cable-machine-42862-large.mp4' },
  'Incline EZ-Bar Skullcrushers': { youtubeId: 'd_KZxkY_0aw', title: 'Incline EZ-Bar Skullcrushers', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-doing-triceps-exercises-with-cable-machine-42862-large.mp4' },
  ...
  'Overhead Dumbbell Tricep Extension': { youtubeId: '_gsU1369vJw', title: 'Overhead Dumbbell Tricep Extension', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-doing-triceps-exercises-with-cable-machine-42862-large.mp4' },
  ...
  'Barbell Bent-Over Row (45° Torso)': { youtubeId: 'FWJR5Ve8gkQ', title: 'Barbell Bent-Over Row', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-doing-bent-over-barbell-rows-40929-large.mp4' },
  'Overhand Barbell Bent-Over Row': { youtubeId: 'FWJR5Ve8gkQ', title: 'Overhand Barbell Bent-Over Row', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-doing-bent-over-barbell-rows-40929-large.mp4' },
  ...
  'Seated Cable Row (V-Bar Close Grip)': { youtubeId: 'GZbfZ033fbo', title: 'Seated Cable Row', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-athlete-working-out-with-cable-machine-42861-large.mp4' },
  ...
  'Barbell Shrugs (Trapezius)': { youtubeId: 'NAqCVEa1n4c', title: 'Barbell Shrugs (Trapezius)', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-doing-overhead-press-with-barbell-40922-large.mp4' },
  ...
  'Kneeling Cable Crunch': { youtubeId: '2fORO_PXGpo', title: 'Kneeling Cable Crunch', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-doing-hanging-leg-raises-for-abs-40932-large.mp4' },
  'Standing Ab Wheel Rollouts': { youtubeId: 'rqiTPdK1cWg', title: 'Standing Ab Wheel Rollouts', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-doing-hanging-leg-raises-for-abs-40932-large.mp4' },
  ...
  'Barbell Front Squat (Deep ATG)': { youtubeId: 'tlfahndPnuw', title: 'Barbell Front Squat (Deep ATG)', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-doing-squats-with-barbell-40930-large.mp4' },
  ...
  'Leg Extensions (VMO Isolation)': { youtubeId: 'YyvSfV-BZQQ', title: 'Leg Extensions (VMO Isolation)', fallbackMp4: 'https://assets.mixkit.co/videos/preview/mixkit-man-doing-squats-with-barbell-40930-large.mp4' },
